...
def find_memory_type_index(
    ...
    for i in range(memory_properties.memoryTypeCount):
        ...
        #O bit i de supportedMemoryIndices é definido se esse tipo de memória for compatível com o dispositivo
        supported = supported_memory_indices & (1 << i)

        #propertyFlags contém todas as propriedades de memória suportadas por esse tipo de memória
