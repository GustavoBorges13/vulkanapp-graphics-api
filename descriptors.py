...
def make_descriptor_set_layout(device, bindings: DescriptorSetLayoutData):
    ...
    try:
        ...
        vklogging.logger.print(f"{FAIL}Falha ao criar o layout do conjunto de descritores{RESET}")
        return None
...
def make_descriptor_pool(device, size: int, bindings: DescriptorSetLayoutData):
    ...
    try:
        ...
        vklogging.logger.print(f"{FAIL}Falha ao criar o pool de descritores{RESET}")
        return None
...
def allocate_descriptor_set(device, descriptorPool, descriptorSetLayout):
    ...
    try:
        ...
        vklogging.logger.print(f"{FAIL}Falha ao alocar um conjunto de descritores (descriptor set){RESET}")
        return None